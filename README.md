...
The examples reference `@v1` and set `pipeline_ref: v1`. This is the simplest centrally managed model: merge a change to this repository's `main`, and consuming repositories pick it up on their next workflow run without changes to their caller files.
